...
contract ZKNOX_NTT {
    ...
    function ZKNOX_NTT_HALFMUL_Compact(
        uint256[] memory a,
        uint256[] memory b
    ) public view returns (uint256[] memory) {
