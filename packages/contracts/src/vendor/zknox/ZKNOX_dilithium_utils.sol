...
uint256 constant q = 8_380_417;
uint256 constant N_MINUS_1_MOD_Q = 8_347_681;
uint256 constant OMEGA = 80;
uint256 constant GAMMA_1 = 131_072;
uint256 constant GAMMA_1_MINUS_BETA = 130_994;
 ...
 */
function bitUnpackAtOffset(
    bytes memory inputBytes,
    uint256 coeffBits,
    uint256 startBitOffset,
    uint256 numCoeffs
) pure returns (uint256[] memory result) {
...
function vecMulMod(
    uint256[] memory a,
    uint256[] memory b
) pure returns (uint256[] memory res) {
 ...
 */
function matVecProduct(
    uint256[][][] memory M,
    uint256[][] memory v
) pure returns (uint256[][] memory mTimesV) {
 ...
 * @return mTimesV Resulting vector
 */
function matVecProductDilithium(
    uint256[][][] memory M,
    uint256[][] memory v
) pure returns (uint256[][] memory mTimesV) {
